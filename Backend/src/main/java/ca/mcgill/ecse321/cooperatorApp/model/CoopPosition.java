...
private StartConfirmation startConfimation;

@OneToOne(optional=false)
public StartConfirmation getStartConfimation() {
   return this.startConfimation;
}

public void setStartConfimation(StartConfirmation startConfimation) {
   this.startConfimation = startConfimation;
}
